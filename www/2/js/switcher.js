;(function($){$.fn.navs=function(o){this.each(function(){var th=$(this),data=th.data('navs'),_={enable:true,actCl:'active',changeEv:'change',indx:[],hshx:[],useHash:false,defHash:'#!/',emptyHash:'#',outerHash:false,autoPlay:false,blockSame:true,hover:true,contRetFalse:true,preFu:function(){_.li.each(function(n){var th=$(this)
_.indx[n]=th
_.useHash&&(_.hshx[n]=$('a',th).attr('href'))&&location.hash==_.hshx[n]&&th.addClass(_.actCl)})
_.def=_.li.parent().find('.'+_.actCl).index()},rfrshFu:function(){_.prev=_.curr
_.pren=_.n
_.curr=false
_.n=-1
_.param='close'
...
return false}
if(location.hash=='#back'){var tmp=_.prevHash
_.prevHash=_.hash
...
location.hash=_.defHash},backFu:function(){console.log(_)
_.chngFu(_.pren==-1||_.pren==void 0?_.def:_.pren)},nextFu:function(){var n=_.n
...
return this}
$.fn.tabs=function(o){return this.each(function(){var th=$(this),_=th.data('tabs')||{enable:true,show:0,blockSame:true,changeEv:'change',empty:'#!/',preFu:function(){_.li.hide()},actFu:function(){_.prev&&_.prev.hide()
_.curr&&_.curr.show()},navFu:function(s){if(_.pres==s||s.slice(0,3)!='#!/')
return false
_.pres=s
s==_.empty&&$.when(_.li).then(_.closeFu)
_.li.each(function(n){$(this).attr('id')==s.slice(3)&&_.chngFu(n)})},chngFu:function(a){if(!_.enable||(a==_.n&&_.blockSame)||a>=_.li.length)
return false
$.when(_.li).then(function(){_.pren=_.n
_.prev=_.curr
_.curr=_.li.eq(_.n=a)
_.actFu(_)
_.me.trigger(_.changeEv)})},nextFu:function(){var n=_.n
_.way=1
_.chngFu(++n<_.li.length-_.show?n:0)},prevFu:function(){var n=_.n
_.way=-1
_.chngFu(--n>=0?n:_.li.length-1-_.show)},closeFu:function(){if(_.pres=='close')
return false
_.pren=_.n
_.prev=_.curr
_.n=-1
_.curr=false
_.pres='close'
_.actFu(_)},backFu:function(){_.chngFu(_.pren)},init:function(){_.ul=$('>ul',_.me)
_.li=$('>li',_.ul)
_.preFu(_)
...
typeof o=='boolean'&&(_.enable=o)
typeof o=='number'&&_.chngFu(o)
typeof o=='string'&&(o=='prev'||o=='next'||o=='close'||o=='back'?_[o+'Fu']():_.navFu(o))})}})(jQuery)